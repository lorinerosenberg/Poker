...
function deal(){
	...
	function collapse() {
        $("#collapse").click(function () {
            $("#collapse").addClass("collapseForm");
            $(".form").removeClass("collapseForm")
        })
    }
	function uncollapse() {
        $("#delete").click(function () {
            $(".form").addClass("collapseForm");
            $("#collapse").removeClass("collapseForm")
        })
    }
...
$(document).ready(function(){
	...
	function collapse() {
        $("#collapse").click(function () {
            $("#collapse").addClass("collapseForm");
            $(".form1").removeClass("collapseForm")
        })
    }
	function uncollapse() {
        $("#delete").click(function () {
            $(".form1").addClass("collapseForm");
            $("#collapse").removeClass("collapseForm")
        })
    }
	collapse();
